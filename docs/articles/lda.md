...
The cosine-similarity matrix among topic exemplars; pairs above ~0.85
signal over-splitting.
[`fit_lda()`](https://marine-ecologist.github.io/symbayes/reference/fit_lda.md)
stores it and the flagged pairs.
...
A text report cross-referencing each topic to clade, host species,
...
the generalist `plot_exemplars(sp, model = "lda")` and
